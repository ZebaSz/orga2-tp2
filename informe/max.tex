...
%	Sería interesante tener como resultado cuán mejor en tiempo una implementación contra la otra.
%Experimentación
...
\begin{minipage}{\linewidth}
	\begin{center} 
		...
		\captionof{figure}{Píxeles contiguos de una fila del kernel, las llaves indican que píxeles se toman en las 2 aplicaciones por fila}
	\end{center}
\end{minipage}
...
\begin{minipage}{\linewidth}
	\begin{center}
		...
		\captionof{figure}{Como queda el registro después de aplicar la instrucción}
	\end{center}
\end{minipage}
...
\begin{minipage}{\linewidth}
	\begin{center}
		...
		\captionof{figure}{Shifts sobre los registros para conseguir el máximo}
	\end{center}
\end{minipage}
