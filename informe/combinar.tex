...
Separo en pares e impares para este paso utilizo las copias de los registros $XMM_i$
...
Shifteo de manera conveniente para luego poder unirlos de manera curzada
...
Hago shuffle de manera conveniente para que nos queden los píxeles preparados para insertan en la imagen resultante
...
En este punto se tienen ordenados ocho píxeles listos para poder grabarlos dentro de la imagen resultado. Para poder realizar el grabado en memoria se van a utilizar cuatro punteros distintos que marcan los cuatro cuadrantes de la imagen estos fueron llamados $R8$ , $R9$, $R10$ y $R11$ siendo que $Ri$ corresponde al puntero al cuadrante $i - 7$. 
...
\node[box] at (+1.5,+1.50) {};
\node[box] at (-1.5,+0.50) {};
\node[box, fill=red] at (-0.50,+0.50) {R11};
\node[box] at (+0.50,+0.50) {};
\node[box, fill=red] at (+1.50,+0.50) {R10};
\node[box] at (-1.50,-0.50) {};
\node[box] at (-0.50,-0.50) {};
\node[box] at (+0.50,-0.50) {};
\node[box] at (+1.50,-0.50) {};
\node[box] at (-1.50,-1.50) {};
\node[box, fill=red] at (-0.50,-1.50) {R9};
\node[box] at (+0.50,-1.50) {};
\node[box, fill=red] at (+1.50,-1.50) {R8};
\end{tikzpicture}
\caption{Posicion de puntero Ri antes de empezar los ciclos}
\end{figure}

El algoritmo siempre utiliza los punteros $R8$ y $R9$ para guardar los ocho píxeles resultantes. Guarda  $P7, P5, P3, P1$ en la posición de memoria ocupada por $R10$ y $P8, P6, P4, P2$ en la posición de memoria ocupada por $R9$ , luego de esto se le suma a $R9, R10$ los bytes de ocho píxeles y se pasa a procesar ocho nuevos píxeles.
...
\node[box] at (+1.5,+1.50) {};
\node[box] at (-1.5,+0.50) {};
\node[box, fill=red] at (-0.50,+0.50) {R9};
\node[box] at (+0.50,+0.50) {};
...
\node[box] at (+0.50,-0.50) {};
\node[box, fill=red] at (+1.50,-0.50) {R10};
\node[box, fill=gray] at (-1.50,-1.50) {};
\node[box, fill=gray] at (-0.50,-1.50) {};
\node[box, fill=gray] at (+0.50,-1.50) {};
\node[box, fill=gray] at (+1.50,-1.50) {};
\end{tikzpicture}
