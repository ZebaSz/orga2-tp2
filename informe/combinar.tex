...
Una vez que tenemos los 8 pixeles ordenados según los quiero procedo a guardarlos en la posiciones de memoria a las que apuntan el registro $R8$ y $R9$ sin preocuparme en este caso del cuadrante donde estos dos están apuntando. Ya que podrían estar apuntando a un lugar del cuadrante 1, 2 o bien al 3, 4. Pasare a mostrar que ocurre con los registros $R8, R9, R10, R11$ durante el primer ciclo de columna y luego de haber cambiado de fila. 

Aquí una imagen intentado mostrar el cambio de estado de los registros : 
